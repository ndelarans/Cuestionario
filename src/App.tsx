...
import Contactanos from './pages/Contactanos'; // Importa el componente Contactanos
      ...
      <div>
        ...
        <main className="p-4">
          <Routes>
            ...
            <Route path="/contacto" element={<Contactanos />} /> {/* Ruta para el componente Contactanos */}
          </Routes>
        </main>
      </div>
    </Router>
